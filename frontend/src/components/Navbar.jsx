...
import { Leaf, Sparkles, Sun, Moon, Globe, ChevronDown, Check, Heart } from 'lucide-react';
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="font-black text-xl tracking-tight text-slate-950 dark:text-white">
                    HealthTech<span className="text-[#519755]">Smart</span>
                  </span>
                </div>
                <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold tracking-wide">
                  {t('brandSubtitle', 'Autonomous Medical & Health Emergency Network')}
                </p>
              </div>
            </Link>
